...
Так как Free Сloud account недоступен в россии даже с помощью трёх букв, то будем использовать Self-Hosted Sentry выделяя ей 4 ядра процессора и 20+Гб оперативной памяти.
